...
export function TopNav() {
  ...
  // Reset term if current term exceeds new degree's max
  useEffect(() => {
  ...
  return (
    <header className="fixed top-0 left-[220px] right-0 z-30 flex h-14 items-center justify-between border-b border-border/50 bg-background/80 backdrop-blur-md px-6">
      <div className="flex items-center gap-2">
        <h1 className="text-sm font-semibold text-foreground">Academic Risk Intelligence</h1>
        <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-mono text-primary">v2.0</span>
      </div>
